            ...
            if filename.endswith('.json'):
                ...
                with open(file_path, 'r') as json_file:
                    ...
                    for key, value in json_data['results'].items():
                        ...
                        gen_kwargs = {"num_beams": None, "length_penalty": None, "no_repeat_ngram_size": None,"max_length": None}
                        # Extract and parse the model_args
                        model_args = json_data.get('config', {}).get('gen_kwargs', gen_kwargs)

                        # Add model_args as individual columns
                        result_row.update(model_args)
